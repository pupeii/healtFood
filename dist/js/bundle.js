...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../dist/node_modules/webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js")))
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      const json = JSON.stringify(Object.fromEntries(formData.entries())); // создаем масив масивов и преобразовываем в объект и конвертим в json формат
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  modalTrigger.forEach(btn => {
    btn.addEventListener('click', () => openModal(modalSelector, modalTimerId)); //оборачиваем в колбэк чтобы функция не вызывалась при загрузке страницы
  });
...
function timer(id, deadline) {
  function getTimeRemaining(endtime) {
    ...
    return {
      ...
      'minutes': minutes,
      'seconds': seconds
    }; //возвращаем все данные одним объектом
  }
...
/* harmony import */ var _js_modules_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/modules/modal */ "./js/modules/modal.js");
/* harmony import */ var _js_modules_timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/modules/timer */ "./js/modules/timer.js");
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => Object(_js_modules_modal__WEBPACK_IMPORTED_MODULE_1__["openModal"])('.modal', modalTimerId), 300000);
  ...
  Object(_js_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', modalTimerId);
  Object(_js_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2020-12-27');
  ...
  Object(_js_modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"])('form', modalTimerId);
  Object(_js_modules_slider__WEBPACK_IMPORTED_MODULE_6__["default"])({
